...
void rst::rasterizer::draw(std::vector<Triangle *> &TriangleList) {
    ...
    for (const auto& triag:TriangleList)
    {
        Triangle newtri = *triag;

        std::array<Eigen::Vector4f, 3> mm {
                (view * model * triag->v[0]),
                (view * model * triag->v[1]),
                (view * model * triag->v[2])
        };
        ...
        Eigen::Vector4f n[] = {
                inv_trans * to_vec4(triag->normal[0], 0.0f),
                inv_trans * to_vec4(triag->normal[1], 0.0f),
                inv_trans * to_vec4(triag->normal[2], 0.0f)
        };
